      ...
      >
        <div className="flex gap-3">
          ...
          <div>
            <p
              className="text-sm font-medium"
              style={{ color: "hsl(202, 100%, 25%)" }}
            >
              Storage Note
            </p>
            <p
              className="text-sm mt-1"
              style={{ color: "hsl(202, 100%, 30%)" }}
            >
      ...
      >
        ...
        <div className="p-6">
          <p className="text-sm mb-6" style={{ color: "hsl(330, 3%, 49%)" }}>
            Upload a CSV file containing your QnA dataset. The file will be
          ...
          {selectedFile && (
            <>
              <div className="mt-6">
                ...
                >
                  Dataset Name{" "}
                  <span style={{ color: "hsl(8, 86%, 40%)" }}>*</span>
                </label>
                <input
                  type="text"
                  value={datasetName}
              ...
              <div className="mt-4">
                ...
                <p
                  ...
                  style={{ color: "hsl(330, 3%, 49%)" }}
                >
                  Number of times to duplicate the dataset rows (leave empty or
                  1 for no duplication)
                </p>
              </div>
            </>
          )}
...
"What is X?","Answer Y"`}
        ...
        >
          ...
          <button
            ...
            style={{
              backgroundColor:
                !selectedFile || !datasetName.trim() || isUploading
                  ? "hsl(0, 0%, 95%)"
                  : "#171717",
              color:
                !selectedFile || !datasetName.trim() || isUploading
