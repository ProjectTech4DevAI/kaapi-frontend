...
export default function ConfigCard({
  ...
  const handleEdit = () => {
    router.push(
      `/configurations/prompt-editor?config=${latestVersion.config_id}&version=${latestVersion.version}`,
    );
  };
  ...
  const handleUseInEvaluation = () => {
    if (onUseInEvaluation) {
      ...
      router.push(
        `/evaluations?config=${latestVersion.config_id}&version=${latestVersion.version}`,
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        >
          <p className="line-clamp-2" style={{ color: colors.text.secondary }}>
