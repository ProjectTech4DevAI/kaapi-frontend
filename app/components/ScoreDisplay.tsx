...
import { ScoreObject, isNewScoreObject, isNewScoreObjectV2, isBasicScoreObject } from './types';
...
export default function ScoreDisplay({ score, errorMessage }: ScoreDisplayProps) {
  ...
  const isNewFormat = (isNewScoreObject(score) || isNewScoreObjectV2(score) || isBasicScoreObject(score));
