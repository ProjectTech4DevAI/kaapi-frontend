...
import { AuthTokenResponse } from "@/app/lib/types/auth";
import {
  CheckCircleIcon,
  WarningIcon,
  SpinnerIcon,
...
export default function TokenVerifyPage({
  ...
  }, [token, apiUrl, loginWithToken, errorFallback]);

  // Drive progress bar and redirect on success
  useEffect(() => {
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        >
          ...
          <div className="px-8 py-10">
            ...
            <p className="text-center text-sm text-text-secondary leading-relaxed max-w-xs mx-auto">
              {status === "verifying" && description.verifying}
