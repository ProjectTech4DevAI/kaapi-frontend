...
import PromptDiffPane from "@/app/components/prompt-editor/PromptDiffPane";
import ConfigDiffPane from "@/app/components/prompt-editor/ConfigDiffPane";
          ...
          <div className="flex gap-3 items-center">
            ...
            >
              ...
              {configGroups.map((group) => (
                <optgroup
                  key={group.config_id}
                  label={`${group.name} (${group.versions.length} versions)`}
                >
                  {group.versions
