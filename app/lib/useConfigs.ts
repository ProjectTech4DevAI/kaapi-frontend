...
export interface SavedConfig {
  ...
  input_guardrails?: Array<{ validator_config_id: string }>; // Input guardrails from config blob
  output_guardrails?: Array<{ validator_config_id: string }>; // Output guardrails from config blob
}
