...
export default function TestEvaluationPage() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "hsl(42, 63%, 94%)" }}
    >
      <div className="max-w-2xl mx-auto p-8">
        ...
        >
          ...
          <p className="mb-6" style={{ color: "hsl(330, 3%, 49%)" }}>
            Click on any evaluation below to view the mock data with the new
            table structure.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "hsl(167, 59%, 95%)")
              }
              onMouseLeave={(e) =>
          ...
          <div
            ...
            style={{
              ...
              borderColor: "hsl(45, 93%, 75%)",
              borderWidth: "1px",
            }}
          >
            <p className="text-sm" style={{ color: "hsl(45, 93%, 25%)" }}>
              <strong>Note:</strong> Mock mode is currently enabled. To switch
              back to real backend data, set{" "}
              <code
                className="px-1 py-0.5 rounded"
                style={{ backgroundColor: "hsl(45, 93%, 90%)" }}
              >
                USE_MOCK_DATA = false
              </code>{" "}
              in <code>/app/api/evaluations/[id]/route.ts</code>
            </p>
          </div>
